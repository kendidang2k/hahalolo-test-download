...
export default function Banner() {
    ...
    return (
        <Grid id="banner" className='banner' sx={{ width: '100%', paddingTop: { xs: '50px', md: '100px' }, paddingBottom: '37%', background: 'linear-gradient(135deg, rgba(0,31,65,1) 0%, rgba(0,66,117,1) 48%, rgba(36,168,216,1) 100%)', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', overflow: 'hidden', paddingLeft: '20px', paddingRight: '20px' }}>
            <BannerContent />
            ...
            <Box sx={{ width: '100%', height: 'auto', overflow: 'hidden', position: 'absolute', bottom: '-50px', zIndex: '8' }}>
